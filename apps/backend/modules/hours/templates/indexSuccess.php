<h1>Uren schrijven - <strong>Week <?php echo $currentWeek; ?> - <?php echo $projId > 0? $projItem->getName():"";?> </strong></h1>
					<hr>
					...
					<form id="select-company" action="<?php echo url_for("hours/save");?>" method="post">
						<div class="formrow">
							<label for="project">Project</label>
							<select id="select-project" name="project">
								<option value="">Selecteer...</option>
								<?php foreach($projList as $proj):?>
									<option value="<?php echo $proj->getId()?>" <?php echo $projId==$proj->getId()?"selected":""; ?>><?php echo $proj->getName()?></option>
								<?php endforeach;?>
							...
							<script>
								$(document).ready(function() {
									$("#select-project").change(function() {
										...
										window.location = "<?php echo url_for("hours/index")?>?w=<?php echo $currentWeek;?>&p="+ curVal;
						...
						<hr>
						<?php if($projId > 0):?>
						<p class="paging"><a class="prev" href="<?php echo url_for("hours/index?w=".($currentWeek-1)."&p=".$projId);?>"><span class="icon">Å</span></a> <a class="next" href="<?php echo url_for("hours/index?w=".($currentWeek+1)."&p=".$projId);?>"><span class="icon">Ä</span></a>Week <?php echo $currentWeek; ?></p>
